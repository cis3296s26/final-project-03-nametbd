(function () {
    ...
    async function getSavedJobs() {
        ...
        async function updateInterviewDate(savedJobId, interviewAt) {
            return client().request(`/api/jobs/saved/${savedJobId}/interview`, {
                method: 'PUT',
        ...
        async function getCalendarEvents() {
            return client().request('/api/jobs/saved/calendar', { method: 'GET' });
        }
